...
config_dict = {
    ...
    'dataset_folder_train' :'UnsupervisedGeometryAwareRepresentationLearning/data/H36M-MultiView-train',
    'dataset_folder_test': 'UnsupervisedGeometryAwareRepresentationLearning/data/H36M-MultiView-test',
